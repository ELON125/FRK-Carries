...
async def on_button_click(res):
    ...
    if str(res.channel.id) == str('859195101774086185') and res.component.label == "📩Buy Carry":
        ...
        choosing_embed = discord.Embed(title='⚠️Fill out bellow!⚠️', description=f'Below you can click the buttons to choose amount of carries/Preferred map etc.\n⚠️Make sure to fill out below, otherwise carriers wont be able to claim the ticket⚠️\n\n――――――――――――――――\n**Amount of Carries**:\n0\n――――――――――――――――\n**Preferred Map**:\nNone\n――――――――――――――――\n\n――――――――――――――――\n**Full Access**:\nFalse\n――――――――――――――――\n**Quest run**:\nFalse\n――――――――――――――――\n').set_footer(text='FRK Tarkov Carries', icon_url="https://media.discordapp.net/attachments/798922297062850600/800336476826763334/chingyhasasmallcock.gif").set_thumbnail(url="https://cdn.discordapp.com/attachments/781284773083480064/856569431031021598/leems_shit_logo.gif")
    ...
    if res.channel.name.startswith("ticket-"):
        ...
        async def update_embed():
            ...
            updated_embed = discord.Embed(title='⚠️Fill out below!⚠️', description=f'Below you can click the buttons to choose amount of carries/Preferred map etc.\n⚠️Make sure to fill out below, otherwise carriers wont be able to claim the ticket⚠️\n\n――――――――――――――――\n**Amount of Carries**:\n{amount_of_carries}\n――――――――――――――――\n**Preferred Map**:\n{preferred_map}\n――――――――――――――――\n\n――――――――――――――――\n**Full Access**:\n{full_access}\n――――――――――――――――\n**Quest run**:\n{quest_run}\n――――――――――――――――\n').set_footer(text='FRK Tarkov Carries', icon_url="https://media.discordapp.net/attachments/798922297062850600/800336476826763334/chingyhasasmallcock.gif").set_thumbnail(url="https://cdn.discordapp.com/attachments/781284773083480064/856569431031021598/leems_shit_logo.gif")
