...
async def on_ready():
    ...
    print(f"Bot is online! {client.user.id}")
...
async def claim_update():
    ...
    while True:
        ...
        tickets_dont_look = await client.fetch_channel(859456327658373120)
        ...
        async for message in tickets_dont_look.history(limit=500):
            ticketMember = await guild.fetch_member(str(message.content.split("/--/")[0]))
            ticketChannel = guild.get_channel(int(message.content.split("/--/")[1]))

            if still_there_check() == True:
                for dbFind in frk_db.find({"ticket_channelID": f"{ticketChannel.id}"}):
                    amount_of_carries = dbFind["amount_of_carries"]

                if amount_of_carries == '0':pass
...
async def on_button_click(res):
    ...
    if str(res.channel.id) == str('859195101774086185') and res.component.label == "📩Buy Carry":
        ...
        choosing_embed = discord.Embed(title='⚠️Fill out bellow!⚠️', description=f'⚠️Make sure to fill out below, otherwise carriers wont be able to claim the ticket⚠️\n\n――――――――――――――――\n**Amount of Carries**:\n0\n――――――――――――――――\n**Preferred Map**:\nNone\n――――――――――――――――\n\n――――――――――――――――\n**Full Access**:\nFalse\n――――――――――――――――\n**Quest run**:\nFalse\n――――――――――――――――\n').set_footer(text='FRK Tarkov Carries', icon_url="https://media.discordapp.net/attachments/798922297062850600/800336476826763334/chingyhasasmallcock.gif").set_thumbnail(url="https://cdn.discordapp.com/attachments/781284773083480064/856569431031021598/leems_shit_logo.gif")
        ...
        hidden_claiming = res.guild.get_channel(859456327658373120)
    ...
    if res.component.label == "🔒Close":
        if frk_db.count_documents({"carrier_id": f"{res.channel.id}"}) > 0:
            ...
            if str(amount_of_carries) is not '':
    ...
    if res.channel.name.startswith("ticket-"):
        ...
        if str(res.channel.id) == str(ticket_channel_id) and res.component.label.startswith("📊Carries Amount"):
        ...
        if str(res.channel.id) == str(ticket_channel_id) and res.component.label.startswith("🗺️Preferred Map"):
    ...
    #When creating a ticket is has to say user_id/--/ticket_channel_id 
        if res.component.label == ("✅Claim"):
            ...
            async for message in res.guild.get_channel(859456327658373120).history(limit=100, oldest_first=True):
